...
namespace LiveCaptionsTranslator.ipc
{
    ...
    public sealed record AudioStreamEndPayload(Guid WorkerSessionId, Guid CaptureSessionId, long FramesSent, long PcmBytesSent, long FirstSequence, long FinalSequence, long SourceSequenceGaps);
    ...
    public static class ProtocolPayloadCodec
    {
        ...
        public static byte[] Encode(AudioStreamEndPayload v) { var w = new PayloadWriter(); w.Guid(v.WorkerSessionId); w.Guid(v.CaptureSessionId); w.Int64(v.FramesSent); w.Int64(v.PcmBytesSent); w.Int64(v.FirstSequence); w.Int64(v.FinalSequence); w.Int64(v.SourceSequenceGaps); return w.ToArray(); }
        public static AudioStreamEndPayload DecodeAudioStreamEnd(ReadOnlySpan<byte> b) { var r = new PayloadReader(b); var v = new AudioStreamEndPayload(r.Guid(), r.Guid(), r.Int64(), r.Int64(), r.Int64(), r.Int64(), r.Int64()); r.RequireEnd(); return v; }
